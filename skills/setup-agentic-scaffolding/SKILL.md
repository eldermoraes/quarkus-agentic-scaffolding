...
|---|---|---|---|
| Claude Code | `claude mcp add -s user quarkus-agent -- jbang --java 21+ io.quarkus:quarkus-agent-mcp:1.2.7:runner` · `claude mcp add -s user context7 -- npx -y @upstash/context7-mcp@4.0.7` | `claude mcp list` | No — restart |
| Codex CLI | `codex mcp add quarkus-agent -- jbang --java 21+ io.quarkus:quarkus-agent-mcp:1.2.7:runner` · `codex mcp add context7 -- npx -y @upstash/context7-mcp@4.0.7` | `codex mcp list` | No — restart; sandbox may block network |
...
| GitHub Copilot CLI | `copilot mcp add quarkus-agent -- jbang --java 21+ io.quarkus:quarkus-agent-mcp:1.2.7:runner` · `copilot mcp add context7 -- npx -y @upstash/context7-mcp@4.0.7` | `copilot mcp list` | **Yes** — live immediately |

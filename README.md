...
add context7 with `claude mcp add -s user context7 -- npx -y @upstash/context7-mcp@4.1.0` (see [authentication and launch environment](#context7-authentication-and-launch-environment)); optionally install superpowers with
...
add context7 with `codex mcp add context7 -- npx -y @upstash/context7-mcp@4.1.0` (see [authentication and launch environment](#context7-authentication-and-launch-environment)); install/enable the Superpowers plugin if you use it; and copy
...
gemini mcp add -s project context7 npx -y @upstash/context7-mcp@4.1.0
